#ifndef LORE_BASE_PASSTHROUGH_CVARIADICARGS_H
#define LORE_BASE_PASSTHROUGH_CVARIADICARGS_H
...
static inline int CVargEntryLength(struct CVargEntry *argv) {
    int argc = 0;
...
#endif // LORE_BASE_PASSTHROUGH_CVARIADICARGS_H
