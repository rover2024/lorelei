...
int mp_vsnprintf_scanf(out_fct_type out, char *buffer, const size_t maxlen, const char *format,
                       va_list va, struct CVargEntry *entries);

// int mp_vprintf_scanf(const char *format, va_list va, struct CVargEntry *entries);
